...
| §6.3 | Initial evidence synthesis | P6 / P7 | KB intake done at P6 (`/pilar:ingest-kb`); the synthesis-into-scaffolding workflow runs through `/pilar:scaffold-pillars` (briefing + manifest grounding) and is exercised pillar-by-pillar in `/pilar:pillar-narrative` / `/pilar:pillar-statements` | done |
...
| §6.5 | Per-pillar development | P7 | `/pilar:pillar-narrative` (Strategic Rationale + Narrative + Scope), `/pilar:pillar-statements` (SS/RS with manifest-aware sourcing + orphan-RS check); status transitions triggered at end of each drafting command | done |
